...
urlpatterns = [
    ...
    path('toggle_ready_status/<int:room_id>/', views.toggle_ready_status, name='toggle_ready_status'),  # Ensure this line exists
    path('check_ready_status/<int:room_id>/', views.check_ready_status, name='check_ready_status'),  # Add this line
